...
\caption{A fitness graph of the multi-unit controller in a 3v3 scenario, with 2 marines and 1 firebat on each team. Fitness progresses slowly over the threshold of 1.0, indicating that the average genome defeats the enemy units more often than not.}
